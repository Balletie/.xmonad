...
-- Copypasted because people are hiding data fields from me :(.

module CopyPasteMonad.Layout.WorkspaceDir (
                                   -- * Usage
                                   -- $usage
                                   workspaceDir,
                                   changeDir,
...
import CopyPasteMonad.Prompt.Directory ( directoryPrompt )
...
changeDir c = directoryPrompt c "cd: " (sendMessage . Chdir)
